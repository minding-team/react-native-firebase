...
// import { SDK_VERSION } from '@minding/react-native-firebase-dynamic-links';
export const SDK_VERSION = version;

// import links from '@minding/react-native-firebase-dynamic-links';
// links().X(...);
...
// import links, { firebase } from '@minding/react-native-firebase-dynamic-links';
// links().X(...);
// firebase.links().X(...);
